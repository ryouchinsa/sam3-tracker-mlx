...
class VitBlock(nn.Module):
    ...
    def __init__(self, config: ViTConfig, is_global: bool = False):
        ...
        rotary_input_size = feat_size if self.window_size == 0 else self.window_size
        rotary_scale = config.window_size / rotary_input_size
...
class ViTBackbone(nn.Module):
    ...
    def __call__(self, x: mx.array) -> mx.array:
        ...
        for idx, layer in enumerate(self.layers):
            x = layer(x, layer._rope_window_cos, layer._rope_window_sin)
